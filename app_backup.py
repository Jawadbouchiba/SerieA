...
def get_team_stats(team):
    ...
    if team_real not in predictor.team_stats:
        return "❌ Équipe non trouvée dans la base de données"
    ...
    with gr.Tabs():
        ...
        with gr.Tab("⚽ FOOTBALL - Serie A"):
            with gr.Tabs():
                ...
                with gr.Tab("🎯 Prédiction de Match"):
            ...
            predict_button.click(
                ...
                with gr.Tab("📊 Statistiques d'Équipe"):
        ...
        # Onglet Comparaison
        with gr.Tab("⚔️ Comparaison d'Équipes"):
        ...
        with gr.Tab("ℹ️ À propos"):
            ...
            Ce prédicteur utilise un **réseau de neurones profond** construit avec PyTorch:
            
            ### 📐 Architecture:
            - **Couche d'entrée:** 19 features (statistiques des deux équipes + lieu)
            - **Couches cachées:** 128 → 256 → 128 → 64 neurones
            - **Activation:** ReLU avec BatchNorm et Dropout
            - **Couche de sortie:** 3 neurones (Victoire, Nul, Défaite) + Softmax
            ...
            ### 🎯 Performance:
            - Entraîné sur les données de Serie A 2020-2025
            - Optimisé avec Adam et learning rate adaptatif
            - Validation croisée pour éviter le surapprentissage
            
            ### 💡 Utilisation:
            1. **Prédiction:** Sélectionnez deux équipes et obtenez les probabilités
            2. **Statistiques:** Analysez les performances d'une équipe
            3. **Comparaison:** Comparez deux équipes directement
            
            ---
            
            **⚠️ Note:** Les prédictions sont basées sur des données historiques et des modèles statistiques.
            Le football reste imprévisible et plein de surprises! 🎲
            """)
    
    gr.Markdown("""
    ---
    <div style="text-align: center;">
        <p>🚀 Développé avec PyTorch & Gradio | 📊 Données Serie A 2020-2025</p>
    </div>
    """)
